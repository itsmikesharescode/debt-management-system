...
<div class="fixed bottom-0 left-0 right-0 top-0 bg-overlay">
	<div class="relative mx-auto mt-[101px] min-h-[362px] w-[255px] bg-white p-2">
		...
		<div class="mt-[30px] flex flex-col gap-[13px]">
			<label>
			...
			<button
				class="flex h-[35px] items-center justify-center rounded-[10px] bg-black text-[12px] font-semibold text-white"
